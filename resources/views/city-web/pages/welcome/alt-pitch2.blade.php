<div data-vc-full-width="true" data-vc-full-width-init="true" class="vc_row wpb_row vc_row-fluid padding-top-6-5vw padding-bottom-6-5vw vc_custom_1595190872085 vc_row-has-fill vc_column-gap-5 vc_row-o-equal-height vc_row-o-content-middle vc_row-flex" style="position: relative; left: -35px; box-sizing: border-box; width: 1140px; padding-left: 35px; padding-right: 35px;"><div class="wpb_column vc_column_container vc_col-sm-6 vc_col-lg-6 vc_col-md-5 vc_col-xs-12 vc_hidden-xs"><div class="vc_column-inner"><div class="wpb_wrapper">
                <div class="wpb_single_image wpb_content_element vc_align_left  vc_custom_1595125976964  center-at-768">

                    <figure class="wpb_wrapper vc_figure">
                        <div class="vc_single_image-wrapper   vc_box_border_grey"><img width="424" height="240" src="https://iconstituent.com/wp-content/uploads/Group-14272.svg" class="vc_single_image-img attachment-full" alt=""></div>
                    </figure>
                </div>
                ...
                <div class="vc_row wpb_row vc_inner vc_row-fluid"><div class="wpb_column vc_column_container vc_col-sm-12 vc_hidden-lg vc_hidden-md vc_hidden-sm"><div class="vc_column-inner vc_custom_1594568560416"><div class="wpb_wrapper">
                                <div class="wpb_single_image wpb_content_element vc_align_center   max-width-400-at-768 padding-bottom-1-8vw">
