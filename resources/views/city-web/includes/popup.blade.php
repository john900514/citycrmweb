<div id="popup" data-aos="zoom-in" class="aos-init aos-animate">
    <div class="mainMenu aos-init aos-animate" data-aos="fade-left">
        <h6><img src="{!! asset('/images/CityCRM-White.png') !!}" alt="CityCRM" width="200"></h6>
        <a href="" class="close"><i class="fa fa-times"></i></a>
        <ul id="menu-header-menu" class="menu">
            <li id="menu-item-54064" class="menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor current-menu-parent menu-item-has-children menu-item-54064"><a>Solutions</a>
                <ul class="sub-menu">
            ...
            <li id="menu-item-54061" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-54061"><a>Features</a>
                <ul class="sub-menu">
            ...
            <li id="menu-item-54358" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-54358"><a href="pricing/">Pricing</a></li>
            <li id="menu-item-54063" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-54063"><a>Resources</a>
                <ul class="sub-menu">
        ...
        <h6>16540 Pointe Village Dr. <br />
            Suite 210<br />
            Lutz, FL 33558</h6>
        <!-- <a href="/schedule-a-demo/" class="button yellow block">Request a Call</a> -->
    </div> <!-- .mainMenu -->
</div> <!-- #popup -->
